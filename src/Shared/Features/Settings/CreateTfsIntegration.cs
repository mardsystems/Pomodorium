...
public class CreateTfsIntegrationRequest : Request<CreateTfsIntegrationResponse>
{
...
public class CreateTfsIntegrationResponse : Response
{
    public CreateTfsIntegrationResponse(Guid correlationId)
        : base(correlationId)
    {

    }

    public CreateTfsIntegrationResponse() { }
}
