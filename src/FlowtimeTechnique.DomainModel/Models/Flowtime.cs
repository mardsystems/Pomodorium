...
namespace FlowtimeTechnique.Models;
...
public class Flowtime : AggregateRoot
{
    ...
    public Flowtime(Guid id, TaskManagement.Models.Tasks.Task task, AuditInterface auditInterface)
    ...
    public Flowtime(TaskManagement.Models.Tasks.Task task, TimeSpan expectedDuration)
    {
        if (task == null)
        {
            throw new ArgumentNullException(nameof(task));
